        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingCourses_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrainingCourses_Trainings_TrainingId",
            ...
            migrationBuilder.InsertData(
                table: "Teachers",
                columns: new[] { "Id", "Name", "Surname" },
                values: new object[] { 1, "Serap", "Uslu" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingCourses_CourseId",
                table: "TrainingCourses",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingCourses_TrainingId",
                table: "TrainingCourses",
                column: "TrainingId");
